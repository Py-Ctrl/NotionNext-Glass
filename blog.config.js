...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'liquidglass', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,example,fukasawa,fuwari,gitbook,heo,hexo,landing,liquidglass,matery,medium,next,nobelium,plog,simple
